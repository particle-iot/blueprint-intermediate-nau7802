...
1. The power configuration lines early in `setup` enables [3V3_AUX which powers the QWIIC expansion port](https://docs.particle.io/reference/datasheets/m-series/muon-datasheet/#expansion-and-peripheral-power) on the Muon.
